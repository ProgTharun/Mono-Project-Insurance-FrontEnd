...
export class CustomerService {
  ...
  private cloudinaryUrl = 'https://api.cloudinary.com/v1_1/dxflz3kgx/auto/upload';
  ...
  uploadToCloudinary(file: File): Observable<any> {
    ...
    return this.http.post('https://api.cloudinary.com/v1_1/dxflz3kgx/auto/upload', formData);
  }
